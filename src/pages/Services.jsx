...
const Services = () => {
    ...
    return (
        ...
        <div key={title} id={`${title}`} className=' relative rounded-[20px] sm:rounded-[50px] p-4 border-2 border-[#cacaca]  cursor-pointer hover:transition-colors transition:border' onClick={() => setReadMore(!readMore)}>
            <img src={image} alt=""  className='w-[100%] rounded-[20px] sm:rounded-[50px] '/>
  ...
  return (
    <div className={`${styles.container} mt-[100px] flex flex-col my-4 gap-6 sm:gap-10`}>
