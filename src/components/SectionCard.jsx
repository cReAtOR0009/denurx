    ...
    return (
      <HashLink to={`/services/#${title}`}>
        <div
          key={title}
          id="title"
          className="serciveCard relative rounded-[20px] sm:rounded-[50px] border-1 border-grey_100  cursor-pointer max-w-[500px] hover:scale-[1.1] group transition"
        ...
        >
          ...
          <img
            src={arrow}
            alt={`arrow indicating the card can be opened to show more information about ${title}`}
