    ...
    >
      ...
      <div>
        ...
        onClick={() => setShowJoinwaitlist(true)}
          className={`rounded-[30px] animate-pulse bg-primaryBtn px-6 py-4 sm:px-6 sm:py-4 text-xxs text-white sm:text-base font-medium uppercase leading-normal  text-primary-700  hover:bg-secondary_100 focus:border-white transition duration-150`}
        >
          Join Waitlist
        </button>
      {/* </a> */}
      ...
      >
        ...
        <ul className="flex flex-col mt-20">
          ...
          <button onClick={() => setShowJoinwaitlist(true)} className="rounded-[30px] animate-pulse bg-primaryBtn  px-6 py-4 sm:px-6 sm:py-4 text-xxs text-white sm:text-base font-medium uppercase leading-normal text-primary-700 border border-[transparent] cursor-pointer hover:bg-secondary_100 focus:border-white transition duration-150">
            Join Waitlist
          </button>
      </aside>
