...
const Privacy = ({ showPrivacy, setShowPrivacy }) => {
  ...
  return (
    <div
      className={`mb-10 h-[100vh] fixed top-0 left-0 bottom-0 right-0 z-[100] pt-[2% flex flex-col justify-center items-center my-0 mx-[auto]  w-[100%]  bg-grey_200 dark:bg-dark-termprivacyBg animate-pop-up `}
    >
      <div
